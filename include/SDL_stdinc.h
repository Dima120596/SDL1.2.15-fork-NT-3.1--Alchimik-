...
#ifdef HAVE_MALLOC
//Для WIN32 malloc не лучшее решение - там лучше использовать GlobalAlloc (тестировано на Win32s)
#if defined(__WIN32__) || defined(_WIN32)
	#define SDL_malloc	GlobalAlloc(GMEM_DISCARDABLE, (size))
#else
...
//Для WIN32 calloc не лучшее решение - там лучше использовать GlobalAlloc (тестировано на Win32s)
#if defined(__WIN32__) || defined(_WIN32)
	#define SDL_calloc(n, size) GlobalAlloc(GMEM_DISCARDABLE | GMEM_ZEROINIT, (n) * (size))
#else
...
#ifdef HAVE_FREE
//Для WIN32 free не лучшее решение - там лучше использовать GlobalAlloc (тестировано на Win32s)
#if defined(__WIN32__) || defined(_WIN32)
	#define SDL_free	 GlobalFree((ptr))
#else
...
//Для WIN32 HAVE_ALLOCA не лучшее решение - там лучше использовать GlobalAlloc (тестировано на Win32s)
#if defined(__WIN32__) || defined(_WIN32)
